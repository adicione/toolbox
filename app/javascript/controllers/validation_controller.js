...
export default class extends Controller {
  ...
  initialize() {
    ...
    this.fields = Array.from(this.element.querySelectorAll("input, textarea, select")).filter(field => { return this.matchValidationKey(field) || field.required })
  ...
  matchValidationKey(field) {
    return Object.keys(this.validations).find(validation => field.classList.contains(validation))
  }

  getValidation(field) {
    return this.validations[this.matchValidationKey(field)]
  }
  ...
  validateBrPhone(field) {
    field.mask = this.maskingController.maskBrPhone.call(this.maskingController, field.value)

    this.maskingController.maskInput(field)
  ...
  validateCpf(field) {
    field.mask = this.maskingController.maskCpf.call(this.maskingController, field.value)
  ...
  validateDate(field) {
    field.mask = this.maskingController.maskDate.call(this.maskingController, field.value)
